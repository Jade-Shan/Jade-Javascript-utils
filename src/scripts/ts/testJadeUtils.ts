...
class TestWebHtmlPage {
	...
	static testJquery() {
		...
		//
		// _1_ 2 3 4 5 6 ... 20
		document.querySelector('#pageBar01')?.appendChild(WebHtmlPage.renderPaging( 1, 20, n => `javascript:console.log('str-${n}')`, n => {console.log(`call-func-${n}`)}));
		// 1 2 3 4 5 6 _7_ 8 9 10 11 12 ... 20
		document.querySelector('#pageBar02')?.appendChild(WebHtmlPage.renderPaging( 7, 20, n => `javascript:console.log('str-${n}')`, n => {console.log(`call-func-${n}`)}));
		...
		document.querySelector('#pageBar02')?.appendChild(WebHtmlPage.renderPaging( 8, 20, n => `javascript:console.log('str-${n}')`, n => {console.log(`call-func-${n}`)}));
		...
		document.querySelector('#pageBar02')?.appendChild(WebHtmlPage.renderPaging(13, 20, n => `javascript:console.log('str-${n}')`, n => {console.log(`call-func-${n}`)}));
		...
		document.querySelector('#pageBar02')?.appendChild(WebHtmlPage.renderPaging(14, 20, n => `javascript:console.log('str-${n}')`, n => {console.log(`call-func-${n}`)}));
		// WebHtmlPage.setElemHtml('#pageBar08', WebHtmlPage.renderPaging(14, 20, n => `javascript:console.log('str-${n}')`));
		// 1 ... 15 16 17 18 19 _20_
		document.querySelector('#pageBar02')?.appendChild(WebHtmlPage.renderPaging(20, 20, n => `javascript:console.log('str-${n}')`, n => {console.log(`call-func-${n}`)}));
